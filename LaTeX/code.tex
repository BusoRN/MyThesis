...
tabsize=2,                       % sets default tabsize to 2 spaces
language=Java,
caption = ElectrovalvesView.java,
label = code:ElectrovalvesView]{./code/glass/ElectrovalvesView.java}
...
tabsize=2,                       % sets default tabsize to 2 spaces
language=Java,
caption = Electrovalves.java,
label = code:Electrovalves]{./code/glass/Electrovalves.java}
...
tabsize=2,                       % sets default tabsize to 2 spaces
language=Java,
caption = HTTPService.java,
label = code:HTTPService]{./code/glass/HTTPService.java}
